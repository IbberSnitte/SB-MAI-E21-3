...
public class FontToolBar extends AbstractToolBar {
    ...
    protected void fontFaceField(int state, GridBagConstraints gbc, JPanel p, ResourceBundleUtil labels, AbstractButton btn) {
    ...
    @FeatureEntryPoint(JHotDrawFeatures.FONT_SIZE)
    protected void fontSizeWithSlider(GridBagConstraints gbc, JPanel p, JPanel p2, ResourceBundleUtil labels) {
    ...
    protected void fontStyleButtons(AbstractButton btn, ResourceBundleUtil labels, GridBagConstraints gbc, JPanel p) {
        // Font style buttons
